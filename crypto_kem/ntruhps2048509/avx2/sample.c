...
void PQCLEAN_NTRUHPS2048509_AVX2_sample_rm(poly *r, poly *m, const unsigned char uniformbytes[NTRU_SAMPLE_RM_BYTES])
{
  ...
  PQCLEAN_NTRUHPS2048509_AVX2_sample_iid(m,uniformbytes+NTRU_SAMPLE_IID_BYTES);
#endif
...
{
  /* Sample r using PQCLEAN_NTRUHPS2048509_AVX2_sample_iid then conditionally flip    */
