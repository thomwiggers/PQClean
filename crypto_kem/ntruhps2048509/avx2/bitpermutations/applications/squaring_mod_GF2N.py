...
if __name__ == '__main__':
    ...
    if args.shufbytes:
        ...
        if args.raw_name:
            f.__name__ = "PQCLEAN_NTRUHPS2048509_AVX2_square_{}_509".format(args.no_of_squarings)
        else:
            f.__name__ = "PQCLEAN_NTRUHPS2048509_AVX2_square_{}_509_shufbytes".format(args.no_of_squarings)
        ...
        if args.raw_name:
            ...
            f.__name__ = "PQCLEAN_NTRUHPS2048509_AVX2_square_{}_509_patience".format(args.no_of_squarings)
