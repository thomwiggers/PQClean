...
.word 2047
.text
.hidden PQCLEAN_NTRUHPS2048509_AVX2_poly_Rq_mul
...
subq $6656, %rsp
mov $4, %ecx
karatsuba_loop_4771e50d450e60120a24959bcd69561c:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_4771e50d450e60120a24959bcd69561c:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_4771e50d450e60120a24959bcd69561c
add $512, %r9
add $1024, %r10
jmp innerloop_4771e50d450e60120a24959bcd69561c
done_4771e50d450e60120a24959bcd69561c:
sub $512, %r9
sub $1024, %r10
vmovdqa 0(%r9), %ymm0
...
add $2048, %r12
dec %ecx
jnz karatsuba_loop_4771e50d450e60120a24959bcd69561c
sub $8192, %r12
add $6656, %rsp
subq $2400, %rsp
