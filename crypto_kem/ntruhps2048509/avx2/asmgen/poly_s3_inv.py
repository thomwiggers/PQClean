...
out += """
int PQCLEAN_NTRUHPS2048509_AVX2___poly_S3_inv(unsigned char *outbytes,const unsigned char *inbytes)
{ 
...
void PQCLEAN_NTRUHPS2048509_AVX2_poly_S3_inv(poly *r_out, const poly *a) {
  ...
  PQCLEAN_NTRUHPS2048509_AVX2___poly_S3_inv((unsigned char *)output,(unsigned char *)input);
