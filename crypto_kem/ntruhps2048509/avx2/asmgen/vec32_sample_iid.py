...
if __name__ == '__main__':
    ...
    p(".text")
    p(".hidden PQCLEAN_NTRUHPS2048509_AVX2_vec32_sample_iid")
    p(".global PQCLEAN_NTRUHPS2048509_AVX2_vec32_sample_iid")
    p(".att_syntax prefix")

    p("PQCLEAN_NTRUHPS2048509_AVX2_vec32_sample_iid:")
    # rdi holds r
