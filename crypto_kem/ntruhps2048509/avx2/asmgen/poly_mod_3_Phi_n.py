...
if __name__ == '__main__':
    ...
    p(".text")
    p(".hidden PQCLEAN_NTRUHPS2048509_AVX2_poly_mod_3_Phi_n")
    p(".global PQCLEAN_NTRUHPS2048509_AVX2_poly_mod_3_Phi_n")
    p(".att_syntax prefix")

    p("PQCLEAN_NTRUHPS2048509_AVX2_poly_mod_3_Phi_n:")
    # rdi holds r
